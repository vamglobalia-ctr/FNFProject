            ...
            <div class="card-body">
                ...
                <div class="row mb-4 opacity-75">
                    ...
                    <div class="col-md-3 text-end">
                        <div class="diet-line" style="justify-content: flex-end; margin-bottom: 0;">
                            <label>Date:</label>
                            <input type="date" name="pod_bd_date" class="form-control-line" style="max-width: 150px;"
                                value="{{ date('Y-m-d') }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="diet-metrics-row">
                    <div class="diet-metric-box">
                        ...
                        <input type="number" step="0.01" name="pod_data" id="heightInput" class="diet-metric-input"
                        ...
                        <small class="text-muted d-block mt-1" style="font-size: 11px;">Initial: {{
                            $initialMeasurements['height'] }} cm ({{ $initialMeasurements['entry_date'] ?? 'First entry'
                            }})</small>
                        @endif
                    </div>
                    <div class="diet-metric-box">
                        ...
                        <small class="text-muted d-block mt-1" style="font-size: 11px;">Initial: {{
                            $initialMeasurements['weight'] }} kg ({{ $initialMeasurements['entry_date'] ?? 'First entry'
                            }})</small>
                        @endif
                    </div>
                    <div class="diet-metric-box">
                        ...
                        <input type="text" name="pod_bmr" id="bmiInput" class="diet-metric-input"
                            value="{{ $latestMeta['pod_bmr'] ?? $initialMeasurements['bmi'] ?? '' }}" readonly
                            placeholder="{{ $initialMeasurements['bmi'] ?? 'Auto-calculated' }}">
                        @if(isset($initialMeasurements['bmi']))
                        <small class="text-muted d-block mt-1" style="font-size: 11px;">Initial: {{
                            $initialMeasurements['bmi'] }} ({{ $initialMeasurements['entry_date'] ?? 'First entry'
                            }})</small>
                        @endif
                    </div>
                    <div class="diet-metric-box">
                ...
                <div class="diet-history-container">
                    ...
                    <div class="diet-line">
                        ...
                        <input type="text" name="over_weight" id="overWeightInput" class="form-control-line"
                            value="{{ $latestMeta['over_weight'] ?? '' }}" placeholder="Auto" readonly>

                        <label>Ideal Body Weight :</label>
                        <input type="text" name="lead_body_weight" id="idealWeightInput" class="form-control-line"
                            value="{{ $latestMeta['lead_body_weight'] ?? '' }}" placeholder="Auto" readonly>

                        <label>Under Weight :</label>
                        <input type="text" name="under_weight" id="underWeightInput" class="form-control-line"
                            value="{{ $latestMeta['under_weight'] ?? '' }}" placeholder="Auto" readonly>

                        <label>Target Weight :</label>
                        <input type="text" name="target_weight" id="targetWeightInput" class="form-control-line"
                            value="{{ $latestMeta['target_weight'] ?? '' }}" placeholder="Auto" readonly>
                    </div>
                    ...
                    <div class="diet-line">
                        ...
                        <select name="bg_rh" class="form-control-line">
                            <option value="" {{ ($latestMeta['bg_rh'] ?? '' )=='' ? 'selected' : '' }}>Select Blood
                                Group</option>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="row mb-3 mt-2">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="s_cholesterol" class="form-control"
                                    value="{{ $latestMeta['s_cholesterol'] ?? '' }}" placeholder="Enter S.Cholesterol">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">S.Triglycerides</label>
                                <input type="text" name="s_triglycerides" class="form-control"
                                    value="{{ $latestMeta['s_triglycerides'] ?? '' }}"
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="vldl" class="form-control"
                                    value="{{ $latestMeta['vldl'] ?? '' }}" placeholder="Enter VLDL">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Non-HDL C</label>
                                <input type="text" name="non_hdl_c" class="form-control"
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="chol_hdl_ratio" class="form-control"
                                    value="{{ $latestMeta['chol_hdl_ratio'] ?? '' }}"
                ...
                <div class="row mb-4">
                    <div class="col-md-12">
                        ...
                        <div class="program-rows-container">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select program-select" name="selected_program[]">
                                            ...
                                            <option value="{{ $prog->program_name }}" {{
                                                ($latestMeta['selected_program'] ?? '' )==$prog->program_name ?
                                                'selected' : '' }}>
                                                {{ $prog->program_name }}
                                            </option>
                                            @endforeach
                            ...
                            <div
                                class="program-row mb-3 {{ $index == 0 ? 'permanent-row' : 'additional-program-row' }}">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Select Program</label>
                                        <select class="form-select program-select" name="selected_program[]">
                                            <option value="">Select Program</option>
                                            @foreach($available_programs as $prog)
                                            <option value="{{ $prog->program_name }}" {{ ($prog_data['program'] ?? ''
                                                )==$prog->program_name ? 'selected' : '' }}>
                                                {{ $prog->program_name }}
                                            </option>
                                            @endforeach
                                        </select>
                ...
                <div class="diet-history-container">
                    ...
                    <div class="diet-line">
                        ...
                        <div class="diet-checkbox-group ms-2">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="food_choices" id="veg_egg"
                                    value="veg_egg" {{ ($latestMeta['food_choices'] ?? '' )=='veg_egg' ? 'checked' : ''
                                    }}>
                                <label class="form-check-label" for="veg_egg">Veg. + Egg</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="food_choices" id="jain" value="jain"
                                    {{ ($latestMeta['food_choices'] ?? '' )=='jain' ? 'checked' : '' }}>
                    ...
                    <div class="diet-line">
                        ...
                        <select name="physical_activity" class="form-control-line">
                            ...
                            <option value="Sedentary (Very Low Activity)" {{ ($latestMeta['physical_activity'] ?? ''
                                )=='Sedentary (Very Low Activity)' ? 'selected' : '' }}>Sedentary (Very Low Activity)
                            </option>
                    ...
                    <div class="diet-line">
                        ...
                        <input type="text" name="habit" class="form-control-line"
                            value="{{ $latestMeta['habit'] ?? '' }}" placeholder="e.g. Tea in morning, smoking...">

                        <label>Food Allergy:</label>
                        <input type="text" name="food_allergy" class="form-control-line"
                            value="{{ $latestMeta['food_allergy'] ?? '' }}" placeholder="e.g. Milk allergy, gluten...">
                    </div>
                    ...
                    <div class="accordion shadow-sm" id="dietHistoryAccordion">
                        <div class="accordion-item border-success border-opacity-25">
                            <h2 class="accordion-header" id="headingTimeline">
                                <button class="accordion-button collapsed bg-success bg-opacity-10 text-success fw-bold"
                                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseTimeline"
                                                ...
                                                <div class="bg-white p-3 rounded border border-success border-opacity-25"
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-3">
                                                            <p class="mb-1 text-muted small fw-bold text-uppercase">
                                                                Water / Activity</p>
                                                            <p class="mb-0 text-dark">{{ $meta['water_intake'] ?? '-' }}
                                                        ...
                                                        <div class="col-md-4">
                                                            <ul class="list-unstyled mb-0 border-top pt-2">
                                                                <li><span class="text-muted">Occupation:</span> {{
                                                                    $meta['occupation'] ?? 'N/A' }}</li>
                                                                <li><span class="text-muted">Waking Time:</span> {{
                                                                    $meta['waking_time'] ?? 'N/A' }}</li>
                                                                <li><span class="text-muted">Sleeping Time:</span> {{
                                                        ...
                                                        <div class="col-md-4">
                                                            <ul class="list-unstyled mb-0 border-top pt-2">
                                                                ...
                                                                <li><span class="text-muted">Snacks:</span> {{
                                                                    $meta['snacks'] ?? 'N/A' }}</li>
                                                                <li><span class="text-muted">Food Choice:</span> {{
                                                                    ucfirst($meta['food_choices'] ?? 'N/A') }}</li>
                                                            </ul>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <ul class="list-unstyled mb-0 border-top pt-2">
                    ...
                    <div class="col-md-12">
                        ...
                        {{-- <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="file" class="form-control" name="before_profile_photo" accept="image/*">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">After Profile Photo</label>
                                <input type="file" class="form-control" name="after_profile_photo" accept="image/*">
                            </div>
                        </div> --}}
                        ...
                        <div class="col-md-6">
                            ...
                            @for ($i = 1; $i <= 5; $i++) <div class="mb-3">
                                ...
                                <input type="file" class="form-control form-control-sm" name="after_picture_{{ $i }}"
                                    accept="image/*">
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-truncate" style="max-width: 200px;">{{ $metaArray['lunch'] ?? '---'
                                        }}</div>
                                </td>
                                <td>
